...
export default function SearchResultPage() {
    ...
    return (
        ...
        //     {/* ===== PAGE WRAPPER ===== */}
        //     <div className="min-h-screen relative pt-26 px-6">
        ...
        //                 </p>
        //             ) : (
        //                 <div className="max-w-6xl mx-auto p-4 space-y-6 max-h-[75vh] overflow-y-auto">
        ...
        //                                     <div className="flex items-center pt-3 w-4xl">
        ...
        //                                         {/* <button
        //                                             className="px-6 py-2 ml-auto rounded-full text-sm font-semibold transition hover:scale-105 cursor-pointer bg-purple-500 text-white"
        //                                         >
        //                                             Request Session
        //                                         </button> */}
        ...
        //                                             }}
        //                                             className="px-6 py-2 ml-auto rounded-full bg-purple-500 text-white"
        //                                         >
        //                                             Request Session
        //                                         </button> */}
        ...
        //                                             className={`px-6 py-2 ml-auto rounded-full text-white
        //                                             ${sending ? "bg-gray-400 cursor-not-allowed" : "bg-purple-500 hover:scale-105"}`}
        //                                         >
